...
@dataclass
class TrainConfig:
    vit_emb_dir     : str   = r"d:\amir lab\RS-Vamba-main\image_extract\outputs\vit_encoded\embeddings"
    text_emb_dir    : str   = r"d:\amir lab\RS-Vamba-main\text_extract\outputs\text_encoded\embeddings"
