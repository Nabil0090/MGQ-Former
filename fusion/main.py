...
def parse_args():
    ...
    parser.add_argument("--vit_emb_dir", type=str,
        default=r"d:\amir lab\RS-Vamba-main\image_extract\outputs\vit_encoded\embeddings",
        help="Path to ViT embedding chunks directory")
    parser.add_argument("--text_emb_dir", type=str,
        default=r"d:\amir lab\RS-Vamba-main\text_extract\outputs\text_encoded\embeddings",
